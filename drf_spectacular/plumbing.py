...
def build_generic_type() -> _SchemaType:
...
def build_media_type_object(schema: _SchemaType, examples=None) -> _SchemaType:
...
def build_examples_list(examples: List[OpenApiExample]) -> _SchemaType:
    schema = {}
...
def list_hash(lst: List[Any]) -> str:
